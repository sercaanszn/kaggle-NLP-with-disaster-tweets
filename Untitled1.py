...
X_train, X_valid, y_train, y_valid = train_test_split(train_df['text'].tolist(),                                                      train_df['target'].tolist(),                                                      test_size=0.05,                                                      stratify = train_df['target'].tolist(),                                                      random_state=0)
